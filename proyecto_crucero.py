...
def estadisticas(compraron , no_compraron , contador_no):
	...
	pregunta = input(''' Que estadisticas desea ver ?
		...
		3) Top 3 cruceros con mas ventas en tickets
		4) La cantidad de personas que compraron y no compraron tickets
		5) Promedio de personas que compraron y no tickets
